...
import appLogoImg from '../assets/logo.svg';
...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28">
      <main>
        <Image src={appLogoImg} alt="NLW Copa" />
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2">
          ...
          />
          <button
            className="px-6 py-4 rounded bg-yellow-500 hover:bg-yellow-700 text-sm text-gray-900 font-bold uppercase"
            type="submit"
          >
            Criar meu bolão
          </button>
